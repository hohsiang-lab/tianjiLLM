...
// WithMaxTokensAlias clones req and maps max_completion_tokens to max_tokens.
func WithMaxTokensAlias(req *model.ChatCompletionRequest) *model.ChatCompletionRequest {
	if req.MaxCompletionTokens == nil {
		return req
	}
	mapped := *req
	mapped.MaxTokens = req.MaxCompletionTokens
	mapped.MaxCompletionTokens = nil
	return &mapped
}
