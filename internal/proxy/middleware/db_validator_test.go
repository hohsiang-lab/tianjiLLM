...
// fakeQuerier is a test double for limitQuerier.
type fakeQuerier struct {
	result db.VerificationToken
	err    error
	team   db.TeamTable
	org    db.OrganizationTable
	budget db.BudgetTable
}
...
func (f *fakeQuerier) GetTeam(_ context.Context, _ string) (db.TeamTable, error) {
	return f.team, nil
}

func (f *fakeQuerier) GetOrganization(_ context.Context, _ string) (db.OrganizationTable, error) {
	return f.org, nil
}

func (f *fakeQuerier) GetBudget(_ context.Context, _ string) (db.BudgetTable, error) {
	return f.budget, nil
}
