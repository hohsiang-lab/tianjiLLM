...
func TestModelEdit_PrefilledForm(t *testing.T) {
	...
	require.Equal(t, 0, f.Count("#edit-model-dialog textarea[name=allowed_orgs]"))
	require.Equal(t, 0, f.Count("#edit-model-dialog textarea[name=allowed_teams]"))
	require.Equal(t, 0, f.Count("#edit-model-dialog textarea[name=allowed_keys]"))
	require.NotContains(t, f.Text("#edit-model-dialog"), "Access Control")
