...
func TestLogsList_ShowsLogs(t *testing.T) {
	f := setup(t)
	f.SeedSpendLog(SeedSpendLogOpts{Model: "gpt-5.6-sol", ReasoningEffort: "low", Spend: 0.05, Tokens: 150, Prompt: 100, Completion: 50})
	...
	assert.Contains(t, body, "gpt-5.6-sol(low)")
	assert.Contains(t, body, "anthropic/claude-sonnet-4-5-20250929")
	assert.NotContains(t, body, "anthropic/claude-sonnet-4-5-20250929()")
